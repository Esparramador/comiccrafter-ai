            ...
            <div className="relative rounded-2xl overflow-hidden bg-black border border-white/5">
              ...
              <div className="p-3 bg-black/60 backdrop-blur-sm flex items-center gap-2">
                ...
                <div className="ml-auto flex gap-1">
                   <Button variant="ghost" size="icon" onClick={() => setShowTimeline(!showTimeline)} className="text-gray-400 hover:text-violet-300 w-8 h-8" title="Línea de tiempo de audio">
